        ...
        <div>
            ...
            <form>
                <div className="mb-3 mt-5">
                    ...
                    <input onChange={handleChange} value={product.title} type="text" className="form-control" id="title"
                ...
                <div className="mb-3">
                    ...
                    <div className="row">
                        <div className="col-6">
                            ...
                            <input onChange={handleChange} value={product.price} type="number" className="form-control"
                                   id="price"/>
                        </div>
                        <div className="col-6">
                            <label htmlFor="quantity" className="form-label">Quantity</label>
                            <input onChange={handleChange} value={product.quantity} type="number"
